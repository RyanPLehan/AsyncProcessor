...
namespace AsyncProcessor.Azure.EventHub.Mock
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// Idea is taken from use of InMemoryPartitionManager
    /// See: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Messaging.EventHubs_5.0.0-preview.5/sdk/eventhub/Azure.Messaging.EventHubs/src/Processor/InMemoryPartitionManager.cs#L11
    /// </remarks>
    internal sealed class MockBlobContainerClient // : BlobContainerClient
    {
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref="MockBlobContainerClient"/> class.
        /// </summary>
        ///
        /// <param name="logger">Logs activities performed by this partition manager.</param>
        ///
        public MockBlobContainerClient(Action<string> logger = null)
        {
            _logger = logger;
